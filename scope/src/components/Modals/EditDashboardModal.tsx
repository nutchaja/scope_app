...
import EditDashboardIcon from "../icon/EditDashboardIcon";
 ...
 function EditDashboardModal(){
    ...
    return(
      <div>
            ...
            <Button onPress={onEditOpen} isIconOnly aria-label="editIcon" size="sm" variant="light" className="ml-13"> <EditDashboardIcon/> </Button>
            <CustomModalRegister className='bg-[#F8F8FF]' isOpen={isEditOpen} onOpenChange={onEditOpenChange}>
              <ModalContent>
                {(onClose) => (
                  <>
                    <ModalHeader className='flex gap-3 items-center'>
                      ...
                      <span> แก้ไขรายละเอียดผู้ใช้ </span>
                    </ModalHeader>
                    <ModalBody>
                    ...
                    <ModalFooter>
                      <Button className='bg-[#21B55D] text-[#FCFCFC] rounded-3xl' onPress={onClose}>
                        <UpdateDataWhite/>
                        อัพเดทข้อมูล
                      </Button>
                    </ModalFooter>
