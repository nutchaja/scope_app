...
function ResearcherModal(){
    ...
    return(
        <>
            ...
            <CustomModalResearcher className='bg-[#F8F8FF]' isOpen={isResearchOpen} placement='side-right' onOpenChange={onResearchOpenChange}>
                <ModalContent>
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody>
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-[#71717A]"> นักวิจัย </div>
                                </div>
