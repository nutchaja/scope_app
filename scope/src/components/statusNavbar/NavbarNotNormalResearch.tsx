...
export default function NavbarNotNormalResearch() {
    return (
        <div className=''>
            <div className='flex items-center pl-10 bg-[#F5A524] max-w-[1564px] mx-auto mt-10 rounded-t-3xl h-[130px]'>
                <RatImage />
                ...
                <div className="flex flex-col">
                    <div className='flex ml-164 mb-2 p-3 text-xl px-11 rounded-2xl text-[#DD9015] bg-[#FCFCFC]'>
                        <StatusNotNormal />
                        <h1 className='pl-3 font-bold'>ผิดปกติ</h1>
                    </div>
                    <SettingResearchModal />
                </div>
            </div>
        </div>
    )
