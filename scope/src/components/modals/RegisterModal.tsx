...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Input, Checkbox, extendVariants } from "@heroui/react";
import { PersonPlusBlack } from '../icons/MiscIcons';
...
export function RegisterModal({ isOpen, onOpenChange }: RegisterModalProps): React.JSX.Element {
  return (
    <CustomModalRegister 
      className='bg-[#F8F8FF]' 
      isOpen={isOpen} 
